...
#Get datas of every books on a category page 
def get_datas_of_category_page(): 
    books_data = []
    for i in articles_links : 
        print(i)
        print(get_book_informations(i)) 
        

test = get_book_informations('https://books.toscrape.com/catalogue/tipping-the-velvet_999/index.html')
print(test)
